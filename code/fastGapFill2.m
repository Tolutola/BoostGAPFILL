function [AddedRxns,newModel] = fastGapFill2(consistMatricesSUX,epsilon,weights,weightsPerReaction)
...
% newRxns=unique(consistMatricesSUX.rxns(A2));
...
%new model
newModel.rxns=consistMatricesSUX.rxns(A2);
newModel.S=consistMatricesSUX.S(:,A2);
newModel.S(all(newModel.S==0,2),:)=[];
newModel.mets=consistMatricesSUX.mets(~all(newModel.S==0,2));
newModel.lb=consistMatricesSUX.lb(A2);
newModel.ub=consistMatricesSUX.ub(A2);
newModel.c=consistMatricesSUX.c(A2);
newModel.rev=consistMatricesSUX.rev(A2);
newModel.subSystems=consistMatricesSUX.subSystems(A2);
newModel.rxnNames=consistMatricesSUX.rxnNames(A2);
