function [solution]=growthExpMatch2(model, KEGGFilename, compartment, iterations, dictionary, logFile, threshold,KEGGBlackList,Rxns2Remove)
...
if nargin<2
    ...
    MatricesSUX = generateSUXMatrix2(model,dictionary, KEGGFilename,KEGGBlackList,compartment,[],model);
end
if nargin <6
    logFile='GEMLog';
end
...
for i = 1: iterations
    solution = solveCobraMILP(MILPproblem,'timeLimit',30*60);
